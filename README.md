...
- **Flexible LLM Provider Abstraction:** Seamlessly switch between **Groq** (`llama-3.3-70b-versatile`), **OpenAI** (`gpt-4o`, `gpt-4o-mini`), **Google Gemini** (`gemini-1.5-flash`), **Ollama**, or the offline grounded fallback synthesizer.
